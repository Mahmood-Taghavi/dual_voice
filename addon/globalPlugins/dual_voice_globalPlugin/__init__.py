...
confspec = {
	...
	"sapi5SecondIsLatin": "boolean(default=True)",
	"sapi5NonLatinPriority": "boolean(default=True)",
	...
	"tempSecondIsLatin": "boolean(default=True)",
	"tempNonLatinPriority": "boolean(default=True)",
	...
	"msspSecondIsLatin": "boolean(default=True)",
	"msspNonLatinPriority": "boolean(default=True)",
	...
	"eSpeakSecondIsLatin": "boolean(default=True)",
	"eSpeakNonLatinPriority": "boolean(default=True)",
